...
class rational
{
  ...
  public:
    ...
    friend T whole(rational r) { return r.p / r.q; }
    friend T div(rational s, rational t) { return whole(s / t); }
    friend rational operator%(rational s, rational t) { return s - div(s, t) * t; }
